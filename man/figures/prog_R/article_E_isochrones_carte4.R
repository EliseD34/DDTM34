...
oceanis::plot_typo_symboles(fondPoints = sf_maternite,
                            ...
                            xLeg = 373000,
                            yLeg = 7694000,
                            titreCarte = "Carte d'isochrones autour des maternités de La Réunion",
...
text(377000, 7689000, labels = "Plus de 60 min", cex = 0.9, pos = 4)
text(377000, 7685000, labels = "Entre 40 min et 60 min", cex = 0.9, pos = 4)
text(377000, 7681000, labels = "Entre 20 min et 40 min", cex = 0.9, pos = 4)
text(377000, 7677000, labels = "Entre 10 min et 20 min", cex = 0.9, pos = 4)
text(377000, 7673000, labels = "Moins de 10 min", cex = 0.9, pos = 4)
