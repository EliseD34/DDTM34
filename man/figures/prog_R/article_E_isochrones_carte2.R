...
# on sélectionne les maternités de Saint-Paul et du Tampon
sf_maternite <- sf_maternite[c(5,7),]
sf_maternite$code <- c("97415","97422")
...
iso2$COL <- oceanis::recup_palette(stylePalette = "defaut", nbNeg = 0, nbPos = 3)[[1]]
...
oceanis::plot_typo_symboles(fondPoints = sf_maternite,
                            ...
                            listFonds = list(mer,com_reg04_fond,iso1,iso2,
                                             com_reg04_border,reg04),
                            emprise = "974",
                            couleurs = c("red","blue"), # couleur du point
                            types = c(1,1), # type de point (voir graphics::pch)
                            tailles = c(2,2), # taille du point
                            ...
                            labels = c("Maternité de Saint-Paul", "Maternité du Tampon"),
...
rectangle1 <- matrix(c(371000,7688000,
                       371000,7686000,
                       375000,7686000,
                       375000,7688000,
                       371000,7688000),
...
rectangle2 <- matrix(c(371000,7684000,
                       371000,7682000,
                       375000,7682000,
                       375000,7684000,
                       371000,7684000),
...
rectangle3 <- matrix(c(371000,7680000,
                       371000,7678000,
                       375000,7678000,
                       375000,7680000,
                       371000,7680000),
...
text(376000, 7687000, labels = "Entre 20 min et 30 min", cex = 0.9, pos = 4)
text(376000, 7683000, labels = "Entre 10 min et 20 min", cex = 0.9, pos = 4)
text(376000, 7679000, labels = "Moins de 10 min", cex = 0.9, pos = 4)
