...
#
# La fonction requeteOsrm_11_nm permet de calculer la durée et la distance entre couples de points
# en face à face ou par croisement.
#
# @param src data.frame (3 colonnes id/lon/lat).
# @param idx_src vecteur numérique (de 1 à n où n est le nombre de couples pour la requête).
# @param dst data.frame (3 colonnes id/lon/lat).
# @param idx_dst vecteur numérique (de 1 à n où n est le nombre de couples pour la requête).
