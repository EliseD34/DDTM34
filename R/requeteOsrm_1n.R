...
#
# La fonction requeteOsrm_1n permet de calculer la durée et la distance entre un point
# et un groupe de points.
#
# @param src data.frame (1 ligne et 3 colonnes id/lon/lat).
# @param idx_src valeur numérique.
# @param dst data.frame (n lignes et 3 colonnes id/lon/lat).
